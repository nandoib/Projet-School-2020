          ...
          <div class="container-fluid">
            ...
            <div class="row">
              ...
              <div class="col-md-12 mb-4 white-text text-center">
                ...
                <h3 class="display-1 mt-5 font-weight-bold white-text">Projet School</h3>
                <hr class="hr-light my-2 w-50">
                <h4 class="subtext-header mt-2 mb-4 animated wow FadeIn">Projet School V2 crée par Nando Ibba</h4>
              </div>
              <!--Grid column-->
            </div>
            <!--Grid row-->
                  ...
                  <div class="card-body z-depth-2">
                     <!--Header-->
                      ...
                      <div class="md-form">
                        ...
                        <label for="form3">Identifiant</label>
                      </div>
                      ...
                      <div class="text-center mt-3">
                        <button class="btn btn-indigo btn-rounded">Valider</button>
                        <hr>
                      </div>
                  </div>
                </div>
