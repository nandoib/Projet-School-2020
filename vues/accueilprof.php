...
<?php
  ...
  $listeuser=selectallbyclasse($_SESSION['classe']);
                ...
                <div class="row">
                  <div class="noteok col-12">
                    ...
                    <div class="logoprincipal col-md-12 mb-4 white-text text-center">
                        ...
                        <!-- Boutton noter un éleve qui appelle le modal -->
                        <button type="button" class="boutton-rond btn btn-outline-white waves-effect mt-5" data-toggle="modal" data-target="#NoterEleve">Noter un éleve</button>
...
<div class="container-fluid">
  <div class="row">
    <div class="modal fade" id="NoterEleve" tabindex="-1" role="dialog" aria-labelledby="NoterEleve"aria-hidden="true">
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          <div class="modal-header text-center">
            <h4 class="modal-title w-100 font-weight-bold">Noter un eleve</h4>
